...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        # z_cfg=z_cfg,
        transformer=dict(
            type='GeMapPerceptionTransformer',
            ...
            decoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            type='GeometryDecoupledAttention',
                            embed_dims=_dim_,
                            num_heads=8,
                            dropout=0.1,
                            num_ins=50,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'gemap/nuscenes_map_infos_temporal_train.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'gemap/nuscenes_map_infos_temporal_val.pkl',
